...
## **1.Prepared the KPI Pivot Tables:** I started by creating several pivot tables from the raw data to track core metrics
...
.
## **2.Analyzed Product and Subproduct Data:** I created another pivot table to see the number of complaints by product and subproduct
...
## **3.Analyzed Trends and Geography:** I set up a pivot table to find trends over time by adding the "date received" and grouping it by years and months
. I also pulled in state information to prepare for a geographic visualization

## **4.Added Interactive Filters:** To make the dashboard dynamic, I inserted a Timeline for the date received and a Slicer for the products
